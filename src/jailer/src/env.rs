...
impl Env {
    ...
    fn setup_jailed_folder(&self, folder: impl AsRef<Path>, permissions: u32) -> Result<(), JailerError> {
...
mod tests {
    ...
    fn test_setup_jailed_folder() {
        ...
        assert!(env.setup_jailed_folder(foo_dir.as_path(), FOLDER_PERMISSIONS).is_ok());
